...
class CREMAnnotationModelTest(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        genomeAnnotation.objects.create(genomeVersion='hg38', annotationVersion='V27', databaseName='gencode')
        ...
        geneAnnotation.objects.create(chr='chr1', start=826206, end=827522, geneID='ENSG00000225880', geneSymbol='LINC00115', alternativeGeneID='', isTF='Unknown', strand='-', annotationVersion_id='V27')
        # one geneAnnotation without a REM, to test for valid genes we have no data for
        geneAnnotation.objects.create(chr='chr1', start=826206, end=827522, geneID='ENSG00000XXXXXX', geneSymbol='LINCXXXXX', alternativeGeneID='', isTF='Unknown', strand='-', annotationVersion_id='V27')
    ...
    def test_API_geneQuery(self):
        ...
        response.render()
        self.assertEqual(response.content, b'[{"geneID":"ENSG00000225880","geneSymbol":"LINC00115","REMID":"REM0001970","chr":"chr1","start":827246,"end":827445,"regressionCoefficient":-0.0749712,"pValue":0.75073,"version":1,"REMsPerCREM":"27","CREMID":"CREM0000464","normModelScore":0.5,"cellTypeScore":{"muscle of leg":1.5},"cellTypeDNase1Signal":{"muscle of leg":13.1186}}]')
    ...
    def test_API_geneInfo(self):
        ...
        self.assertEqual(response.content, b'[{"geneID":"ENSG00000225880","chr":"chr1","start":826206,"end":827522,"geneSymbol":"LINC00115","alternativeGeneID":"","strand":"-","annotationVersion":"V27"}]')
        self.assertEqual(response.status_code, 200)

    def test_API_REMQuery(self):
        print('API - REM Query')
        response = self.client.get('/REST_API/REMQuery/REM0001970/')
        response.render()
        # print(response.content)
        self.assertEqual(response.content, b'[{"REMID":"REM0001970","chr":"chr1","start":827246,"end":827445,"geneID":"ENSG00000225880","geneSymbol":"LINC00115","regressionCoefficient":-0.0749712,"pValue":0.75073,"normModelScore":0.5,"version":1,"REMsPerCREM":"27","CREMID":"CREM0000464","cellTypeScore":{"muscle of leg":1.5},"cellTypeDNase1Signal":{"muscle of leg":13.1186}}]')
        self.assertEqual(response.status_code, 200)
    ...
    def test_API_CREMQuery(self):
        ...
        response.render()
        # print(response.content)
        self.assertEqual(response.content, b'[{"CREMID":"CREM0000464","chr":"chr1","start":826308,"end":827500,"REMsPerCREM":"27","REMID":"REM0001970","linkedGene":"ENSG00000225880","REM_Start":827246,"REM_End":827445,"REM_RegressionCoefficient":-0.0749712,"REM_Pvalue":0.75073,"REM_normModelScore":0.5,"version":1}]')
        self.assertEqual(response.status_code, 200)

    def test_API_RegionQuery(self):
        print('API - Region Query')
        response = self.client.get('/REST_API/RegionQuery/chr1:816308-837500/')
        response.render()
        # print(response.content)
        self.assertEqual(response.content, b'[{"geneID":"ENSG00000225880","geneSymbol":"LINC00115","REMID":"REM0001970","chr":"chr1","start":827246,"end":827445,"regressionCoefficient":-0.0749712,"pValue":0.75073,"normModelScore":0.5,"version":1,"REMsPerCREM":"27","CREMID":"CREM0000464","cellTypeScore":{"muscle of leg":1.5},"cellTypeDNase1Signal":{"muscle of leg":13.1186}}]')
        self.assertEqual(response.status_code, 200)
